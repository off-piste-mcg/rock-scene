...
function CloudSprite({ position, scale, speed }) {
  const matRef = useRef();
...
export default function Environment() {
  ...
  const clouds = useMemo(() => [
    // near the rock — wispy fog
    { position: [0, -1.8, 0.5], scale: [4, 2.5, 1], speed: 1.0 },
    { position: [-1.2, -2.0, 0.8], scale: [3.5, 2, 1], speed: 0.8 },
    { position: [1.5, -1.9, 0.3], scale: [3, 2, 1], speed: 1.2 },
    { position: [0.3, -2.1, -0.5], scale: [3.5, 2.5, 1], speed: 0.9 },
    { position: [-0.8, -1.7, 1.0], scale: [2.5, 1.8, 1], speed: 1.1 },

    // bottom fog layer — wider, more spread out
    { position: [0, -2.5, 0], scale: [9, 2.5, 1], speed: 0.6 },
    { position: [-3, -2.6, -1], scale: [7, 2, 1], speed: 0.5 },
    { position: [3, -2.6, -1], scale: [7, 2, 1], speed: 0.7 },
    { position: [0, -2.7, -0.5], scale: [8, 2, 1], speed: 0.45 },
    { position: [-1.5, -2.5, 0.5], scale: [6, 1.8, 1], speed: 0.55 },
  ], []);
